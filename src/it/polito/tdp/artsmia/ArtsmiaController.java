...
public class ArtsmiaController {
	...
	void doAnalizzaOggetti(ActionEvent event) {
		model.creaGrafo();
		txtResult.setText(String.format("Grafo creato: %d vertici e %s archi\n", model.getGraphNumVertices(),model.getGraphEdges()));
	}
	...
	void doCalcolaComponenteConnessa(ActionEvent event) {
		...
		if(!model.isObjValid(idObj)) {
			txtResult.appendText(String.format("Non esiste nessun oggetto valido con id=%d\n",idObj));
